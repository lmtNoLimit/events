    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form class="needs-validation" novalidate
          action="{{action('SessionController@update', [$event->id, $session->id])}}" method="POST">
          @csrf
          <div class="row">
          ...
          <div class="row">
            <div class="col-12 col-lg-4 mb-3">
              ...
              <select class="form-control" id="selectRoom" name="room">
                ...
                <option value="{{$room->id}}" {{old('room', $session->room_id) == $room->id ? 'selected' : ''}}>
                  {{$room->name}}
                </option>
                @endforeach
                @endforeach
          ...
          <div class="row">
            <div class="col-12 col-lg-6 mb-3">
              ...
              <input type="text" class="form-control @if($errors->has('start')) is-invalid @endif" id="inputStart"
                name="start" placeholder="yyyy-mm-dd HH:MM" value="{{old('start', $session->start)}}">
              @if($errors->has('start'))
              <div class="invalid-feedback">
            ...
            <div class="col-12 col-lg-6 mb-3">
              ...
              <input type="text" class="form-control @if($errors->has('end')) is-invalid @endif" id="inputEnd"
                name="end" placeholder="yyyy-mm-dd HH:MM" value="{{old('end', $session->end)}}">
              @if($errors->has('end'))
              <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-12 mb-3">
              ...
              <textarea class="form-control @if($errors->has('description')) is-invalid @endif" id="textareaDescription"
                name="description" placeholder="" rows="5">{{old('description', $session->description)}}</textarea>
